...
class AddNewModisCategoricalFunctions < ActiveRecord::Migration
...
SQL
    ...
    sql1 =<<SQL
    CREATE OR REPLACE FUNCTION terrapop_MODIS_categorical_binary_summarization_v12012016( sample_geog_level_id bigint, raster_variable_id bigint, raster_bnd bigint) 
