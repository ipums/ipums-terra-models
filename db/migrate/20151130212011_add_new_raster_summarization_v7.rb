...
class AddNewRasterSummarizationV7 < ActiveRecord::Migration

  def change
    sql =<<-SQL
    CREATE OR REPLACE FUNCTION terrapop_glc_binary_summarization_v7(IN sample_geog_lvl_id bigint, IN rasters_id bigint)
      ...
      $BODY$
            ...
            FROM data_rast b inner join area_ref_rast a on b.gid = a.gid
