...
class NewHarvestGliSummaryFunctionIi < ActiveRecord::Migration

  def change
    sql = <<SQL
    CREATE OR REPLACE FUNCTION terrapop_gli_harvest_areal_summarization_v5(IN sample_geog_lvl_id bigint, IN rasters_id bigint)
